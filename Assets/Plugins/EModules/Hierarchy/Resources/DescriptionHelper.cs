...
namespace EModules
{
    class DescriptionHelper : MonoBehaviour, IHashProperty
    {
        ...
        [HideInInspector][SerializeField]List<int> Hash9 = new List<int>();
        ...
        public List<int> GetHash9() { return Hash9 ?? (Hash9 = new List<int>()); }
        public void SetHash9(List<int> hash) { Hash9 = hash; }
